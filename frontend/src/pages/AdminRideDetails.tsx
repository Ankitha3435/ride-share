...
import { ArrowLeft, Calendar, Clock, MapPin, User, Users, Car, CreditCard, AlertTriangle, Trash2 } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              ...
              {ride.hitchers.filter(h => h.status === 'accepted').length > 0 && (
                <span className="block mt-2 text-red-600 font-medium">
                  ⚠️ This ride has {ride.hitchers.filter(h => h.status === 'accepted').length} accepted hitcher(s). 
                  You may need to cancel the ride first.
                </span>
              )}
            </p>

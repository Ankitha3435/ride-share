    ...
    const fetchUserDetails = async () => {
      try {
        ...
        setFormData({
          ...
          homeCoordinates: response.data.homeCoordinates || undefined,
          vehicleType: response.data.driverProfile?.vehicle?.type || null,
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <input
                      ...
                      value={formData.homeCoordinates?.lat || ''}
                      onChange={(e) => {
                        ...
                        setFormData(prev => ({
                          ...
                          homeCoordinates: {
                            lat: lat,
                            lng: prev.homeCoordinates?.lng || 0
                          }
                        }));
                      }}
                      step="0.000001"
                    ...
                    <input
                      ...
                      value={formData.homeCoordinates?.lng || ''}
                      onChange={(e) => {
                        const lng = parseFloat(e.target.value);
                        setFormData(prev => ({
                          ...prev,
                          homeCoordinates: {
                            lat: prev.homeCoordinates?.lat || 0,
                            lng: lng
                          }
                        }));
                      }}
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    {formData.homeCoordinates?.lat && formData.homeCoordinates?.lng 
                      ? `Coordinates set: ${formData.homeCoordinates.lat.toFixed(6)}, ${formData.homeCoordinates.lng.toFixed(6)}`
                      : 'Not set - will use geocoding for map display'}
                  </p>
                  <p className="mt-1 text-xs text-blue-600">
                    💡 Tip: Search address on Google Maps → Right-click location → Copy coordinates
                  </p>
                </div>
                  ...
                  <>
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          const value = e.target.value === "" ? null : e.target.value as "scooter/bike" | "car";
                      ...
                      <p className="mt-1 text-xs text-gray-500">
                        Set this for existing users who haven't updated their profile
                      </p>
                    </div>
              ...
              <div className="space-y-4">
                ...
                {user.driverProfile?.vehicle && (
                  <div>
                    ...
                    <div className="mt-1 space-y-1">
                      <p className="text-sm">
                        <span className="font-medium">Vehicle:</span> {user.driverProfile.vehicle.model}
                      </p>
                      <p className="text-sm">
                        <span className="font-medium">Type:</span> {user.driverProfile.vehicle.type || "Not set"}
                      </p>
                      <p className="text-sm">
                        <span className="font-medium">Seats:</span> {user.driverProfile.vehicle.seats}
                      </p>
                      <p className="text-sm">
                        <span className="font-medium">Price per km:</span> ₹{user.driverProfile.pricePerKm}
                      </p>
                    </div>
                  </div>
                )}

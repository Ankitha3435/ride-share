...
const DriverDashboard: React.FC = () => {
  ...
  const handleAcceptRequest = async (rideId: string, hitcherId: string) => {
    try {
      ...
      // Automatically expand the ride to show accepted hitchers
      ...
      // Show success notification with prompt to view profile
      setNotification({
        show: true,
        message: "Request accepted successfully! Scroll down to view hitcher contact details.",
        type: "success"
      });
        ...
        >
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl w-full mx-4 my-8 max-h-[90vh] overflow-y-auto relative">
            ...
            {(() => {
              ...
              // Safety check: if currentRequest is undefined, close the modal
              if (!currentRequest) {
                closeRequestModal();
                return null;
              }
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <div className="bg-green-100 border-2 border-green-600 rounded-lg px-3 py-2 my-2 inline-block">
                          <h3 className="text-xl font-bold text-green-700">
                            Fare: ₹{currentRequest.fare || 0}
                          </h3>
                        </div>

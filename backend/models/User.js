...
// Create indexes in background - silently handle errors
User.createIndexes().catch(err => {
    // Silently ignore index errors - they might already exist or have conflicts with old data
});
